...
void encode_init(void) {
    ...
    pwm_init_pin(DEFAULT_GPIO_PWM0, slice_num_0, chan_num_0, get_clkdiv_hz(DEFAULT_HZ_PWM), DEFAULT_WRAP_PWM);

    chan_num_1 = pwm_gpio_to_channel(DEFAULT_GPIO_PWM1);
    slice_num_1 = pwm_gpio_to_slice_num(DEFAULT_GPIO_PWM1);
    pwm_init_pin(DEFAULT_GPIO_PWM1, chan_num_1, slice_num_1, get_clkdiv_hz(DEFAULT_HZ_PWM), DEFAULT_WRAP_PWM);
}
